export function Header({name, onChange, toggleSelect, isSelect, delMultipleModal, openFolder}) {
    return (
        <h1 className="text-3xl px-4 font-bold flex items-center justify-between min-h-[100px] w-full bg-gray-900 text-white sticky top-0">
            ...
            <div className="flex items-center gap-2">
                <button onClick={openFolder} className="hover:bg-red-400 rounded-full p-1 cursor-pointer"><img src="../src/assets/libraryAssets/folder.png" className="h-6"/></button>
