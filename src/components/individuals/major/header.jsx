...
export function Header({name, search, toggleSelect, isSelect, deleteModal, openFolder}) {
    return (
        <h1 className="text-3xl px-4 font-bold flex items-center justify-between min-h-[100px] w-full bg-gray-900 text-white sticky top-0">
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="flex items-center">
                    ...
                    <input type="text" className="text-[14px] p-1 border-2 border-white outline-0 focus:border-red-400" onChange={search}/>
                </div>
            </div>
        </h1>
    );
