...
export function CollectionEntry({ collectionName, getAllCollections, contextMenu, setContextMenu }) {
    ...
    return (
        <>
            <div onContextMenu={e => setContextData(e)} onDoubleClick={openCollection} title={name} className="relative w-50 h-50 rounded-md flex flex-col justify-center items-center cursor-pointer hover:bg-gray-400/20">
