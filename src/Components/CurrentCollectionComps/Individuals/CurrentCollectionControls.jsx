...
export function CurrentCollectionControls({ getCurrentCollection }) {
    ...
    return (
        <button onClick={copyToCollection} className="flex flex-col justify-center items-center text-white font-bold border-2 border-white cursor-pointer w-50 h-50 hover:border-red-400 hover:bg-red-400">
            <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" fill="#fff" viewBox="0 0 16 16">
